return {
	...
	opts = {
		on_attach = function()
			local api = require("outline.api")
			local jump_to_location = api.jump_to_location

			api.jump_to_location = function(location, ...)
				jump_to_location(location, ...) -- Call the original function
				vim.cmd("normal! zt") -- Execute `zt` after jumping
			end
		end,
		{
			outline_window = {
